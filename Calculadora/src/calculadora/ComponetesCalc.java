...
public class ComponetesCalc extends javax.swing.JFrame 
{

    public ComponetesCalc() 
    {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CALCULADORA APP ");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
            conta1 = Double.parseDouble(txtResultado.getText());
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
            conta2 = Double.parseDouble(txtResultado.getText());
            if(operador == "+" )
            {
                txtResultado.setText(String.valueOf(conta1+conta2));
            }
            if(operador == "-" )
            {
                txtResultado.setText(String.valueOf(conta1-conta2));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComponetesCalc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComponetesCalc().setVisible(true);
            }
        });
    }
