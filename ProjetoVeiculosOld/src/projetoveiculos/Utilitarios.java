 ...
 */
public class Utilitarios extends Carros {
    ...
    public Utilitarios(){
        ...
        System.out.println("Voce quer carregar o veiculo? 1-sim 2-nao");
        x=Entrada.nextInt();
        this.carregar(x);
    }
    private void carregar(int z){
        if (z==1){
            this.setCarga(true);
            System.out.println("Porta malas carregado");
        }else{
            this.setCarga(false);
        }
    }
    ...
    public void Status(){
        System.out.println("Seu carro utilitario é:");
